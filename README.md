...
- [Move](#move)
- [Remove](#remove)
- [LS](#work with ls in advanced level)
- [Touch](#touch)
- [Find](#find)
- [File](#file)
...
- [xargs](#xargs)
- [TEE](#tee)
- [Process in Terminal](#process in terminal)
- [PS](#ps)
- [Top](#top)
- [Free](#free)
- [Uptime](#uptime)
...
- [Mount](#mount)
- [Swap](#swap)
- [Manage File-Permission and Ownerships](#Manage File-Permission and Ownerships)
- [Hard Link & Soft link (symbolic)](#Hard Link & Soft link (symbolic))
- [Find system files and place files in correct location](#Find system files and place files in correct location)
- [Tricks](#tricks)
